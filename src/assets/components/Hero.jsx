  ...
  return (
    <div className="relative w-full h-full flex justify-end bg-gradient-to-t from-black via-transparent to-black overflow-hidden">
      ...
      <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
        ...
        <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-gray-800 bg-opacity-50 text-white shadow-2xl">
          ...
          <p className="mt-3 text-gray-100 font-firacode">
            Your trusted companion in the dynamic job market. We provide
            tailored opportunities, expert guidance, and a wealth of resources
            to empower job seekers on their journey to professional success.
            Navigate with confidence, unlock your potential, and find your path
            to a fulfilling career with us.
          </p>
        </div>
      ...
      <div className="absolute left-1/2 bottom-0 w-full md:w-2/3 flex justify-around items-end transform -translate-x-1/2">
        ...
        <a
          href="#link"
          className="group relative py-5 mr-1 w-40 rounded-t-xl bg-white bg-opacity-50 text-center text-gray-600 font-semibold font-firacode transition-all duration-300 transform hover:pb-14"
        >
          Our Story
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          href="#link"
          className="group relative py-5 ml-1 w-40 rounded-t-xl bg-white bg-opacity-50 text-center text-gray-600 font-semibold font-firacode transition-all duration-300 transform hover:pb-14"
        >
          Our Contact
          <svg
            xmlns="http://www.w3.org/2000/svg"
